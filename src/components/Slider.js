            ...
            <div className="slider">
                <div className="first-section max-w-md px-4 mx-auto sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24">
                    <div className="relative z-[1]">
                        <Link to='/' className='space-x-2 flex items-center'><img className="h-8 w-auto" src="assets/images/logo.svg" alt="LayoffAlert logo" />
                            <p className="text-2xl font-sans font-bold text-gray-900">LoffAlert</p></Link>
